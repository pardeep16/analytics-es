...
var bucket=require('./_response_writer');
var TabifyBuckets =require('./_buckets');

var tabifyAggResponse =function(aggs, esResponse, respOpts = {}) {
  const write = new bucket.TabbedAggResponseWriter(aggs, respOpts);
